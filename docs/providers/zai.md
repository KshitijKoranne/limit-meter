...
LimitMeter is a GUI app. A one-off `export ...` in a terminal session will not be visible when you launch LimitMeter from
Spotlight/Launchpad. Persist it, then restart LimitMeter.
...
3. Enable the Z.ai plugin in LimitMeter settings
