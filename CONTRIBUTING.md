...
- Match the existing design language. LimitMeter has a specific look and feel.
...
You can also [open an issue](https://github.com/KshitijKoranne/limit-meter/issues/new?template=new_provider.yml) to request a provider without building it yourself.
...
Don't open a PR for large features without discussing first. [Open an issue](https://github.com/KshitijKoranne/limit-meter/issues/new?template=feature_request.yml) and make your case.
...
- [@KshitijKoranne](https://github.com/KshitijKoranne) (lead)

Release tags (`v*`) are owner-managed and can only be created by the LimitMeter maintainers.

## Questions?

Open a [bug report](https://github.com/KshitijKoranne/limit-meter/issues/new?template=bug_report.yml) or [feature request](https://github.com/KshitijKoranne/limit-meter/issues/new?template=feature_request.yml) using the issue templates.
